        ...
        { 
...
#if ( defined(RAD_CONSOLE) && !defined( RAD_GC ) ) || defined( RAD_TVOS )
            ...
            if ( xIC2 != NULL )
            {
                printf( "[InputManager]   Found controller: type='%s' class='%s' loc='%s' connected=%d\n",
                        xIC2->GetType( ),
                        xIC2->GetClassification( ),
                        xIC2->GetLocation( ),
                        xIC2->IsConnected( ) ? 1 : 0 );
            }
            else
            {
                printf( "[InputManager]   No controller at that location\n" );
            }
            fflush( stdout );
#endif
#else
...
void InputManager::SetGameState( Input::ActiveState state )
{
    ...
    switch( mGameState )
    {
        case Input::ACTIVE_NONE: oldStateName = "NONE"; break;
        case Input::ACTIVE_GAMEPLAY: oldStateName = "GAMEPLAY"; break;
        case Input::ACTIVE_FRONTEND: oldStateName = "FRONTEND"; break;
        case Input::ACTIVE_SS_GAME: oldStateName = "SS_GAME"; break;
        case Input::ACTIVE_FIRST_PERSON: oldStateName = "FIRST_PERSON"; break;
        case Input::ACTIVE_ANIM_CAM: oldStateName = "ANIM_CAM"; break;
        case Input::ACTIVE_ALL: oldStateName = "ALL"; break;
    }
    switch( state )
    {
        case Input::ACTIVE_NONE: newStateName = "NONE"; break;
        case Input::ACTIVE_GAMEPLAY: newStateName = "GAMEPLAY"; break;
        case Input::ACTIVE_FRONTEND: newStateName = "FRONTEND"; break;
        case Input::ACTIVE_SS_GAME: newStateName = "SS_GAME"; break;
        case Input::ACTIVE_FIRST_PERSON: newStateName = "FIRST_PERSON"; break;
        case Input::ACTIVE_ANIM_CAM: newStateName = "ANIM_CAM"; break;
        case Input::ACTIVE_ALL: newStateName = "ALL"; break;
        case Input::DEACTIVE_ANIM_CAM: newStateName = "DEACTIVE_ANIM_CAM"; break;
    }
    printf( "[InputManager] SetGameState: %s (0x%x) -> %s (0x%x)\n", oldStateName, mGameState, newStateName, state );
    fflush( stdout );
#endif

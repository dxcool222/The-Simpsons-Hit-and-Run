...
//////////////////////////////////////////////////////////////////////////
        ...
        for( i= mStaticTreeWalker.rCurrent().mSEntityElems.mUseSize-1; i>-1; i-- )
        {
            ...
            bool isZ3 = (ex >= -250.0f && ex <= 100.0f && ez >= -650.0f && ez <= -350.0f);
            if(isZ3) sZ3TotalCount++;
#endif
        ...
        {
            printf("[Z3_CULL_DIAG] Total=%d Culled=%d Passed=%d\n", 
                   sZ3TotalCount, sZ3CulledCount, sZ3PassedCount);
            fflush(stdout);
            sZ3TotalCount = 0;
            sZ3CulledCount = 0;
            sZ3PassedCount = 0;

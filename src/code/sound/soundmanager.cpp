...
void SoundManager::SetMasterVolume( float volume )
{
    ...
    if ( m_musicPlayer )
    {
        SetMusicVolumeWithoutTuner( m_pSoundRenderMgr->GetTuner()->GetMusicVolume() );
        SetAmbienceVolumeWithoutTuner( m_pSoundRenderMgr->GetTuner()->GetAmbienceVolume() );
    }
}
...
#ifdef RAD_TVOS
    // tvOS: Pass NULL to let RSD header determine actual encoding
